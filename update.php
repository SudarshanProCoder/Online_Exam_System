...
if (isset($_SESSION['key'])) {
  if (@$_GET['fdid'] && $_SESSION['key'] == 'sudarshan21') {
    $id = @$_GET['fdid'];
...
//delete user
if (isset($_SESSION['key'])) {
  if (@$_GET['demail'] && $_SESSION['key'] == 'sudarshan21') {
    $demail = @$_GET['demail'];
...
if (isset($_SESSION['key'])) {
  if (@$_GET['demail1'] && $_SESSION['key'] == 'sudarshan21') {
...
//remove quiz
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'rmquiz' && $_SESSION['key'] == 'sudarshan21') {
    $eid = @$_GET['eid'];
...
//add quiz
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == 'sudarshan21') {
    $name = $_POST['name'];
...
//add question
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == 'sudarshan21') {
    $n = @$_GET['n'];
    $eid = @$_GET['eid'];
    $ch = @$_GET['ch'];
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
  ...
  } else if ($_SESSION['key'] != 'sudarshan21') {
